...
/**
 * Implementation of {@link JavaTypeFactoryImpl}.
 *
 * <p><strong>NOTE: This class is experimental and subject to
 * change/removal without notice</strong>.</p>
 */
public class SamzaJavaTypeFactoryImpl
    extends JavaTypeFactoryImpl {

  public SamzaJavaTypeFactoryImpl() {
    this(RelDataTypeSystem.DEFAULT);
  }

  public SamzaJavaTypeFactoryImpl(RelDataTypeSystem typeSystem) {
    super(typeSystem);
  }
